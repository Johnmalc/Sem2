...
public class View extends JFrame implements Observer {
	...
	public View(Controller control) {
		...
		sl_contentPane.putConstraint(SpringLayout.EAST, splitPane, 0,
				SpringLayout.EAST, contentPane);
		splitPane.setOrientation(JSplitPane.VERTICAL_SPLIT);
		splitPane.setOneTouchExpandable(true);
		sl_contentPane.putConstraint(SpringLayout.NORTH, splitPane, 0,
				SpringLayout.NORTH, contentPane);
		sl_contentPane.putConstraint(SpringLayout.WEST, splitPane, 0,
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, lblAktZahl, 1,
				SpringLayout.SOUTH, splitPane);
		sl_contentPane.putConstraint(SpringLayout.WEST, lblAktZahl, 0,
				SpringLayout.WEST, splitPane);
	...
	public void update(Observable o, Object arg1) {
		this.label.setText(((Model) o).counterToString());
